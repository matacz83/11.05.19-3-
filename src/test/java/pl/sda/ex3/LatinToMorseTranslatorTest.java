...
public class LatinToMorseTranslatorTest {
    ...
    public void shouldTranslateText() {
        ...
        final InMemoryLatinMorseDictionary dictionary = new InMemoryLatinMorseDictionary();
        final Translator translator = new LatinToMorseTranslator(dictionary.getDictionary());
